  ...
  func startRecording(options: RecordVideoOptions,
    ...
    CameraQueues.cameraQueue.async {
      ...
      do {
        ...
        recordingSession = try RecordingSession(url: url, //ztesting: was tempURL
      ...
      self.recordingSession = recordingSession
        var videoOrientation: Orientation

        videoOrientation = .portrait
        if (options.orientation == "landscape-left"){
      ...
      guard var videoSettings = self.recommendedVideoSettings(videoOutput: videoOutput,
                                                              fileType: options.fileType,
                                                              videoCodec: options.codec, orientation: videoOrientation),
...
//        videoSettings[AVVideoWidthKey] = options.videoWidth
//        videoSettings[AVVideoHeightKey] = options.videoHeight

        // Now you can set the video composition in the video settings dictionary
